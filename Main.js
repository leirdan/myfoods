...
const dietRoutes = require(__dirname + "Routes/diet_routes");
const mealsRoutes = require(__dirname + "Routes/meals_routes");
const userRoutes = require(__dirname + "Routes/user_routes");
